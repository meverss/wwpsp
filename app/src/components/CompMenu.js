	  ...
	  <section className="main_menu" id="main_menu">
		<div className="menu_bar" id="menu_bar">
		  <div className="menu" id="menu">
			<p className="menu_item" data-menuitem="s_welcome" id="welcome"><FaHome className="mIcon"/>&nbsp; HOME </p>
		  ...
		  <div className="m_menu_container" id="m_menu_container">
			<div className="m_menu" id="m_menu">
			  <ul>
				<li className="m_menu_item" data-menuitem="s_welcome" id="m_welcome"><FaHome className="mIcon" />&nbsp;HOME</li>
